...
int ledPinRed = D0;                // Red LED connected to digital pin D0 - On when taking a sample (activity indicator)
...
const float TcOffset = 1.01;           // If Needed
...
void loop(){
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    u8g2.setCursor(0, 9);
    u8g2.print(" SMOKER   FOOD  ");

    u8g2.setFont(u8g2_font_inb24_mr); // Width 21, Hight 33
...
////    u8g2.setCursor(0, 8);
////    u8g2.print("HIGH ALARM");
    
////    u8g2.setCursor(0, 11);
    ////u8g2.print("LOW ALARM");
    u8g2.sendBuffer();
    ...
    Serial.print("Smoker_Temp_as_published_in_F:");
    Serial.println(ts);

    Serial.print("Ave_Thermistor_Resistance_in_Ohms:");
    Serial.println(Rmave);
    
    Serial.print("Food_Temp_as_published_in_F:");
    Serial.println(tf);
